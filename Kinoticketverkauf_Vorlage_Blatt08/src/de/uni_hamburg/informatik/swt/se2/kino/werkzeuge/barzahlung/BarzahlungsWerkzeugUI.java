...
class BarzahlungsWerkzeugUI
{
    ...
    private final String TITEL = "Barzahlung";

    private final String ZUZAHLEN = "zu zahlen:";
    private String _zuzahlen_betrag;

    private final String GEZAHLT = "gezahlt:";
    private JTextField _eingabebetrag;

    private final String RESTBETRAG = "Restbetrag:";
    private String _restbetrag;

    private final String BESTAETIGEN = "OK";
    private final String ABBRECHEN = "Abbrechen";
    ...
    private void erstelleHauptfenster(int zuzahlen)
    {
        ...
        _restbetrag = "0"; // zeigt anfangs den Wert 0 an, wird später durch das BarzahlungsWerkzeug berechnet.
        ...
        _hauptfenster
            .add(new JLabel(_restbetrag, SwingConstants.CENTER));
    }
    ...
    public String getZuzahlenBetrag()
    {
        return _zuzahlen_betrag;
    }
